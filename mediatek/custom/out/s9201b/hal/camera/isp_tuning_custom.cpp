...
)   const
{
    ...
    INT32 i4FluorescentIndex = rCamInfo.rAWBInfo.i4FluorescentIndex;
...
//                   THH2  TH2  THL2                   THH1  TH1  THL1
   ...
   MY_LOG(
       " i4FluorescentIndex = %d, CCT=(%d,%d)\n"
       ,i4FluorescentIndex, rCamInfo.eIdx_Shading_CCT,eIdx_Shading_CCT_new
   );
    if (eIdx_Shading_CCT_new == eIDX_Shading_CCT_D65){
	if (i4FluorescentIndex < DAYLIGHT_F_IDX){
           MY_LOG(
               " Switch to i4FluorescentIndex = %d\n"
               ,i4FluorescentIndex
	        );
             eIdx_Shading_CCT_new = eIDX_Shading_CCT_CWF; 
        }
