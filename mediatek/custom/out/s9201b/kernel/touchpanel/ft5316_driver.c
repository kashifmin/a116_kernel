...
#define TPIO_WAKEUP     	0xff			//GPIO_CTP_EN_PIN      //GPIO187
...
//Ivan
    ...
    printk("tpd_local_init I am here 00\n");
...
//Ivan config Wakeup pin ??? assume high active???
    ...
    //hwPowerOn(MT65XX_POWER_LDO_VGP2, VOL_2800, "TP");    // VOL_2800
    msleep(10);	
...
{
#if 1				//line  <tp> <> <20121222> lishengli  
//    hwPowerDown(TPD_POWER_SOURCE,"TP");
    ...
    mt_set_gpio_out(TPIO_RESET,0);				//output low
    hwPowerDown(MT65XX_POWER_LDO_VGP5, "TP");		//line  <tp> <> <20121222> lishengli  
...
//Ivan
    ...
    printk("[mtk-tpd] lishengli touch_event_handler \n");
    cinfo.pending=0;
