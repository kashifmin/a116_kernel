...
static int HI253_CAPATURE_FLAG = 0;//Add By Paul
static int HI253_CAPATUREB_FLAG = 0;//Add By Paul
...
{ 
	...
	//Dark BLC
	HI253WriteCmosSensor(0xa0, 0x41);
	HI253WriteCmosSensor(0xa2, 0x41);
	HI253WriteCmosSensor(0xa4, 0x41);
	HI253WriteCmosSensor(0xa6, 0x41);
	...
	HI253WriteCmosSensor(0x61, 0x60);// 74 7E
	HI253WriteCmosSensor(0x62, 0x60);// 76
	...
	HI253WriteCmosSensor(0x6b, 0x7d); //80
	HI253WriteCmosSensor(0x6c, 0x82); //80
	...
	HI253WriteCmosSensor(0x4a, 0x90);//dark2
	...
	HI253WriteCmosSensor(0x63, 0x90);
...
//	HI253WriteCmosSensor(0x56, 0x40);//03
//	HI253WriteCmosSensor(0x57, 0xa0);//f7
//	HI253WriteCmosSensor(0x58, 0x24);//14
//	HI253WriteCmosSensor(0x59, 0x68);//88
	
	HI253WriteCmosSensor(0x56, 0x00);
	HI253WriteCmosSensor(0x57, 0xff);
	HI253WriteCmosSensor(0x58, 0x00);
	HI253WriteCmosSensor(0x59, 0xff);
	...
	HI253WriteCmosSensor(0x66, 0x6a); 
	 HI253WriteCmosSensor(0x67, 0x55); 
	 HI253WriteCmosSensor(0x68, 0xa9); 
 	...
 	HI253WriteCmosSensor(0x6d, 0xa9);
  	HI253WriteCmosSensor(0x6e, 0x55);
   HI253WriteCmosSensor(0x6f, 0x55);//修改曝光区域权限//2013.4.1


	
	
	HI253WriteCmosSensor(0x70, 0x3a); 
	HI253WriteCmosSensor(0x71, 0xBb);
	HI253WriteCmosSensor(0x71, 0x89);	
	// haunting control
    ...
    HI253WriteCmosSensor(0x40, 0xf7); 
    HI253WriteCmosSensor(0x41, 0x73); //73
    ...
    HI253WriteCmosSensor(0x83, 0x4f);
    HI253WriteCmosSensor(0x84, 0x10);
    HI253WriteCmosSensor(0x85, 0x52);
    HI253WriteCmosSensor(0x86, 0x25);
    HI253WriteCmosSensor(0x87, 0x45);
    HI253WriteCmosSensor(0x88, 0x39);
    HI253WriteCmosSensor(0x89, 0x35);
    HI253WriteCmosSensor(0x8a, 0x28);
    HI253WriteCmosSensor(0x8b, 0x40);
    HI253WriteCmosSensor(0x8c, 0x38);
    HI253WriteCmosSensor(0x8d, 0x34);
    HI253WriteCmosSensor(0x8e, 0x28);
    HI253WriteCmosSensor(0x8f, 0x58);
    HI253WriteCmosSensor(0x90, 0x4e);
    HI253WriteCmosSensor(0x91, 0x4a);
    HI253WriteCmosSensor(0x92, 0x3b);
    HI253WriteCmosSensor(0x93, 0x33);
    HI253WriteCmosSensor(0x94, 0x2c);
    HI253WriteCmosSensor(0x95, 0x26);//2a
    HI253WriteCmosSensor(0x96, 0x1f);//24
    HI253WriteCmosSensor(0x97, 0x1f);//20
                      ...
                      MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
  ...
  spin_unlock(&hi253_drv_lock);
    ...
    //HI253WriteCmosSensor(0x61, 0x70);// 74
    //HI253WriteCmosSensor(0x62, 0x70);// 76
  ...
  HI253WriteCmosSensor(0x48, 0x88);// 84//78
  //Saturation
  //HI253WriteCmosSensor(0x61, 0x68);// 74 7E
  //HI253WriteCmosSensor(0x62, 0x6a);// 76//60
                      ...
                      MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
  ...
  HI253WriteCmosSensor(0x48, 0x88);// 84
  //Saturation
  //HI253WriteCmosSensor(0x61, 0x65);// 74 7E
  //HI253WriteCmosSensor(0x62, 0x65);// 76
 ...
 // HI253_OPCLK =HI253Status.CapOpClk*100000*5/2*1/Clock_Divider*1/2;
  ...
  HI253WriteCmosSensor(0x01, 0xf8); // Sleep OFF  
  HI253SetMirror(IMAGE_NORMAL);
  HI253_CAPATURE_FLAG = 1;
  HI253_CAPATUREB_FLAG = 1;
  return ERROR_NONE;
} /* HI253Capture() */
...
BOOL HI253SetWb(UINT16 Para)
{
  ...
  switch (Para)
  {
    ...
    case AWB_MODE_AUTO:
		...
		HI253WriteCmosSensor(0x83, 0x4a);
		HI253WriteCmosSensor(0x84, 0x1a);//17//1a
		HI253WriteCmosSensor(0x85, 0x52);
		HI253WriteCmosSensor(0x86, 0x30);//25
		HI253WriteCmosSensor(0x10, 0xf9);
      break;
...
/*  HI253SetPage(0x10);  
  ...
  switch (Para)
  {
    ...
    case AE_EV_COMP_00:                /* EV 0 */
      HI253WriteCmosSensor(0x40,0x85);//84
      break;
...
UINT32 HI253YUVSensorSetting(FEATURE_ID Cmd, UINT32 Para)
{
  switch (Cmd) {
    case FID_SCENE_MODE:
      ...
      {
       if( HI253_CAPATURE_FLAG == 0)
            {
             HI253NightMode(KAL_FALSE); 
            }
            else
        HI253_CAPATURE_FLAG = 0;
	...
	if( HI253_CAPATUREB_FLAG == 0)
         {
		HI253SetBanding(Para);

        }
         else
        HI253_CAPATUREB_FLAG = 0;
...
UINT32 HI253YUVSetVideoMode(UINT16 FrameRate)
{
  ...
  else
  {
    ...
    HI253WriteCmosSensor(0x10, 0x10); 
	HI253WriteCmosSensor(0x11, 0x93);  // Fixed frame rate OFF   HI253Status.VDOCTL2 
	HI253WriteCmosSensor(0x90, 0x08); // BLC_TIME_TH_ON
	HI253WriteCmosSensor(0x91, 0x08); // BLC_TIME_TH_OFF
	HI253WriteCmosSensor(0x92, 0x88); // BLC_AG_TH_ON  //0xd8 mj 0x78
	HI253WriteCmosSensor(0x93, 0x80); // BLC_AG_TH_OFF //0xd0 mj 0x70
	HI253WriteCmosSensor(0x03, 0x02); // Page 2
	HI253WriteCmosSensor(0xd4, 0x08); // DCDC_TIME_TH_ON
	HI253WriteCmosSensor(0xd5, 0x08); // DCDC_TIME_TH_OFF
	HI253WriteCmosSensor(0xd6, 0x88); // DCDC_AG_TH_ON //0xd8 mj 0x78
	HI253WriteCmosSensor(0xd7, 0x80); // DCDC_AG_TH_OFF //0xd8 mj 0x70
	...
	HI253WriteCmosSensor(0x84, 0xed); // EXPTIMEM
	HI253WriteCmosSensor(0x85, 0x68); // EXPTIMEL
	HI253WriteCmosSensor(0x88, 0x04); // EXPMAXH min fps
	HI253WriteCmosSensor(0x89, 0xed); // EXPMAXM
	HI253WriteCmosSensor(0x8a, 0x68); // EXPMAXL
	HI253WriteCmosSensor(0x91, 0x06); // EXPMAXH min fps
	HI253WriteCmosSensor(0x92, 0x66); // EXPMAXM
	HI253WriteCmosSensor(0x93, 0x01); // EXPMAXL  
	HI253WriteCmosSensor(0x01, 0xf8); // Sleep OFF
    spin_lock(&hi253_drv_lock);
	HI253Status.AECTL1 |= 0x80;
    spin_unlock(&hi253_drv_lock);
